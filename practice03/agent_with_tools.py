"""
Practice 03: 支持工具调用的 AI Agent
基于 Practice 01 的 HTTP 客户端，实现 Function Calling 功能
"""
...
class ToolCallingAgent:
    ...
    def _build_system_prompt(self) -> str:
        """构建包含工具说明的系统提示词"""
        prompt = """你是一个智能文件管理助手。你可以使用以下工具来帮助用户管理文件：
...
请根据用户的需求，选择合适的工具来完成任务。"""
    ...
    def _call_llm(self, with_tools: bool = True) -> Dict[str, Any]:
        ...
        body = self._build_request_body(
            tools=TOOLS_DEFINITION if with_tools else None
        )
...
def print_banner():
    """打印程序横幅"""
    print("=" * 60)
    print("🛠️  Practice 03: 工具调用 Agent")
    print("=" * 60)
    print("\n可用工具:")
